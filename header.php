...
<div class="w3-top">
 <div class="w3-bar w3-theme-blue-grey w3-left-align w3-large">
  ...
  <div class="w3-dropdown-hover w3-hide-small">
    <button class="w3-button w3-padding-large" title="Filiéres"><i class="fa fa-graduation-cap"></i><span class="w3-badge w3-right w3-small w3-green">3</span></button>     
    <div class="w3-dropdown-content w3-card-4 w3-bar-block" style="width:300px">
      <a href="http://localhost/wordpress/genie-informatique/" class="w3-bar-item w3-button">Génie Informatique</a>
      <a href="http://localhost/wordpress/technique-de-management/" class="w3-bar-item w3-button">Technique de Management</a>
